...
- 2026-09-11 — Final public hardening: pushed commit `a3d564b` to GitHub and Sites, verified the commitment-binding column in hosted D1, received HTTP 200, and completed both post-deploy hosted smoke outcomes. Independent security review found no release blocker or high-severity issue.
