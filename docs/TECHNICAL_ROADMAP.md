...
| M5 | Complete usable interface | **Complete** | Workshop-style three-pane UI; paced goal → selection → funding → reveal/verification → decision simulation; replayable success/refund paths; commodity terms and buyer-value receipt |
